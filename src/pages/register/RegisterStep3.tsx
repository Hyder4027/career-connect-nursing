          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-screen-lg">
              ...
              <CardContent>
                ...
                <ScrollArea className="h-48 w-full border rounded-lg p-4 bg-muted/30 mb-4">
                  <div
                    className="space-y-4 text-sm text-muted-foreground pr-4"
                    onScroll={(e) => {
                      ...
                      if (
                        ...
                        setHasReadTerms(true); // mark as read
                      }
                    }}
                    style={{ maxHeight: "11rem", overflowY: "auto" }} // force scrollable area
                  >
                    <h4 className="font-semibold text-foreground">
                      CareConnect Terms of Service
                    </h4>
                    <p>
                      1. <strong>Account Registration:</strong> By creating an
                      account, you agree to provide accurate and complete
                      information...
                    </p>
                    <p>
                      2. <strong>Profile Accuracy:</strong> All details
                      submitted in your profile must be truthful and
                      verifiable...
                    </p>
                    <p>
                      3. <strong>Data Protection:</strong> Your personal
                      information will be processed in compliance with GDPR and
                      German laws...
                    </p>
                    <p>
                    ...
                    <p>
                      5. <strong>Service Availability:</strong> We cannot
                      guarantee uninterrupted access due to maintenance or
                      technical issues...
                    </p>
                    <p>
                      6. <strong>Third-Party Employers:</strong> CareConnect is
                      not responsible for contracts or work conditions provided
                      by third parties...
                    </p>
                    <p>
                      7. <strong>Termination:</strong> We may suspend or
                      terminate your account if you breach these terms...
                    </p>
                    <p>
                      8. <strong>Limitation of Liability:</strong> CareConnect
                      is not liable for employment outcomes or indirect
                      damages...
                    </p>
                    <p>
                      9. <strong>Amendments:</strong> These Terms & Conditions
                      may be updated. Continued use means acceptance of updates.
                    </p>
